...
public class BehaviorTreeNodeView : UnityEditor.Experimental.GraphView.Node
{
    ...
    public void ValidateNode(BehaviorTreeSerializer serializer)
    {
        ...
        RemoveFromClassList("bt-node-incomplete");
        tooltip = "";
        ...
        {
            // Not an error — a tree under construction always has childless composites.
            // Use a muted style so real errors (red) stand out from work-in-progress.
            AddToClassList("bt-node-incomplete");
