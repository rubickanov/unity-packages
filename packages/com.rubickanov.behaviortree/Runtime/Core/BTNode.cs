...
namespace Rubickanov.BehaviorTree.Runtime
{
    ...
    public abstract class BTNode
    {
        ...
        /// <summary>
        /// Creates a deep copy of this node, preserving the source GUID. Keeping the GUID
        /// lets the editor map runtime nodes back to their asset counterparts for live
        /// play-mode visualization. Use <see cref="ShallowClone"/> when a fresh GUID is
        /// required (editor copy/paste).
        /// </summary>
