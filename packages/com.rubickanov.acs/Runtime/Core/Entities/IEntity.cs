...
namespace Rubickanov.ACS.Runtime
{
    ...
    {
        /// <summary>
        /// Session-local stable id, allocated at construction and unchanged for the entity's
        /// lifetime. Used by <see cref="World.TryFindById"/> for direct lookup and by future
        /// cross-entity references stored inside aspect data. Every <see cref="IEntity"/> has
        /// a non-<see cref="EntityId.None"/> id — there is no "unidentified entity" state.
        /// </summary>
        EntityId Id { get; }
