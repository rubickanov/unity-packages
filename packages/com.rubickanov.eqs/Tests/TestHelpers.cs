...
namespace Rubickanov.EQS.Tests
{
    ...
    internal sealed class DeterministicTest : EQSTest
    {
        ...
        // Compute() is Clamp01 — this test never returns a negative score, so domination
        // pruning is allowed to run after it.
    ...
    internal sealed class SpyTest : EQSTest
    {
        ...
        // Constant 0.5 — never filters, so it doesn't disable upstream domination pruning.
        public override bool NeverFilters => true;
