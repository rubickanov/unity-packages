...
namespace Rubickanov.ACS.Runtime.Netcode
{
    ...
    internal static class AotHints
    {
        ...
        private static void UsedOnlyForAOTCodeGeneration()
        {
            ...
            new AuthorityRenderBinding<float>(default!, default!, default);
            new AuthorityRenderBinding<double>(default!, default!, default);
            new AuthorityRenderBinding<Vector2>(default!, default!, default);
            new AuthorityRenderBinding<Vector3>(default!, default!, default);
            new AuthorityRenderBinding<Vector4>(default!, default!, default);
            new AuthorityRenderBinding<Quaternion>(default!, default!, default);
            new AuthorityRenderBinding<Color>(default!, default!, default);
