...
{
    /// <summary>
    /// Marks a <c>ReactiveProperty&lt;T&gt;</c> field on an aspect for automatic network replication.
    /// The field's value is synchronized from the authority side to all other clients.
    /// </summary>
