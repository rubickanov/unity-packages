...
namespace Rubickanov.ACS.Runtime.Netcode.Tests
{
    ...
    public class PredictionScannerTests
    {
        ...
        {
            // PredictionScanner is cache-free — it delegates to ReplicationScanner,
            // whose caches own the per-type memoization and must be cleared between
            // tests so a warmer cache doesn't serve stale outputs into a fresh fixture.
