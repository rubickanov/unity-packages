...
namespace Rubickanov.ACS.Runtime.Netcode.Tests
{
    ...
    {
        // Covers the step-7 snapshot contract: tick-keyed byte[] slots with
        ...
        public void BeginWrite_ThenTryGet_ReturnsSameSlotBytesForSameTick()
        {
            ...
            byte[] writeSlot = buffer.BeginWrite(10);
        ...
        public void TryGet_AfterWrapAround_RejectsOldTick()
        {
            ...
            var a = buffer.BeginWrite(10);
            a[0] = 0xAA;
            a[1] = 0xBB;

            var b = buffer.BeginWrite(10 + SnapshotBuffer.Capacity);
            b[0] = 0xCC;
            b[1] = 0xDD;
        ...
        public void BeginWrite_SameTickTwice_OverwritesPreviousBytes()
        {
            ...
            var first = buffer.BeginWrite(5);
            first[0] = 0x11;
            first[1] = 0x22;

            var second = buffer.BeginWrite(5);
            second[0] = 0x33;
            second[1] = 0x44;
